...
<input type="text" value="<?php  ?>" hidden="true" id="txt_t_usuario">
<body>
    <div id="wrapper">
                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            ...
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?php ?></strong> 
                             </span> <span class="text-muted text-xs block"><?php ?> <b class="caret"></b></span> </span> </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="../model/usuarios/modelo_cerrar_sesion.php">Salir</a></li>
                            </ul>
                        </div>
                    ...
                    <li id="opcion_usuarios">
                        ...
                        <ul class="nav nav-second-level">
                            <!--<li><a href="javascript: embebido('usuario_listar.php')"><span class="fa fa-pencil-square-o"></span> Listar Usuarios</a></li> -->
                    ...
                    <li id="opcion_clientes">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="javascript: embebido('clientes/clientes_mantenimiento.php')">Mantenimiento</a></li>
                    ...
                    <!--
                    <li id="opcion_cronogramas">
                        <a href="index-2.html"><i class="fa fa-calendar"></i> <span class="nav-label">Cronograma</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="javascript: embebido('cronograma/cronograma_registrar.php')">Registrar Cronograma</a></li>
                            <li><a href="javascript: embebido('cronograma/cronograma_listar.php'">Listar</a></li>
                            <li><a href="javascript: embebido('cronograma/cronograma_reporte.php'">Reporte</a></li>
                           
                        </ul>
                    </li>
                    <li id="opcion_tarifas">
                        <a href="index-2.html"><i class="fa fa-money"></i> <span class="nav-label">Tarifa</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="javascript: embebido('tarifa/tarifa_registrar.php')">Registrar Tarifa</a></li>
                            <li><a href="javascript: embebido('tarifa/tarifa_listar.php'">Listar</a></li>
                            <li><a href="javascript: embebido('tarifa/tarifa_reporte.php'">Reporte</a></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <span class="m-r-sm text-muted welcome-message">Sistema Venta de Pasajes y Encomiendas</span>
                    </li>

                    <li>
                        <a href="../model/usuarios/modelo_cerrar_sesion.php">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div id="texto_notificacion_1"></div>
            </div>
          </div>
    ...
    <script src="_recursos/js/Lista_Auspiciador.js"></script>



    <script src="_recursos/js/consola_usuario.js" type="text/javascript"></script>
    
    <script>function embebido(url){$("#contenido_embebido").load(url);}</script>

</body>
</html>
<script src="_recursos/js/consola_panel.js" type="text/javascript"></script>
