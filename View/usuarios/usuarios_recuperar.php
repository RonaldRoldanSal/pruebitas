...
<html>
    ...
    <body>
        <div class="container" id="container">
            <div class="row">
                <div class="form-group"><h2 align="center"><span class="glyphicon glyphicon-home"></span> ETEPSAC - Recuperar Contraseña</h2><hr></div>
                <div>
                ...
                <div class="panel panel-default">
                    <div class="panel panel-header">
                        <div class="page-header" style="text-align:center;">
                          <h1 ><small>Recuperacion de contraseña <br> <span class="glyphicon glyphicon-random"></span></small></h1>
                        </div>
                        
                    </div>
                    <div class="panel panel-body" style="text-align:center;">
                        <h3><span class="label label-warning">Ingrese su email</span></h3>
                        <form method="post" class="form-inline" action="../../controller/usuarios/Controller_usuario_RecuperarPassword.php"> 
